...
function Grid2({ progress, label, index, title, description, clickDetails, onClick  }) {
...
<div className="first"><p>Start Date: 20 Dec 2022 <Button2/></p><h4>ATLANTIC HALL SCHOOL</h4>
