...
const NewDepartment = () => {
  ...
  return (
    <form>
        ...
        <h4 className="Head"><br className="smallbreak"/> Create New Department <HiX style={{marginLeft:'5.5em', marginTop:'-0.2em'}}/></h4>
...
<label htmlFor="description">Description:</label>
   ...
   <input id="file" name="file" type='file' placeholder="Add Media"  >
