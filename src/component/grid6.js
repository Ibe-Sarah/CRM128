...
function Grid6({ progress, label, index, title, description, clickDetails, onClick  }) {
...
<div style={{marginTop:'3em'}} className="first"><p>Start Date: 20 Dec 2022 <Button6/></p><h4>ATLANTIC HALL SCHOOL</h4>
